...
contract NTTEvent is ERC1238 {
    ...
    //ERROR: contract creator cannot burn because of second require statement
    //solution: require(msg.sender ==  eventInfo.creator || whitelist[_owner] == Status.Claimed)
    function burnTokenEvent(uint256 _tokenId) public {
        ...
        require(
            whitelist[_owner] == Status.Claimed ||
                msg.sender == eventInfo.creator,
            "Cannot burn revoked/unclaimed token"
        );
